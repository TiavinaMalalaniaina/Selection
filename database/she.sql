...
CREATE VIEW "public".forum_problem_retired AS  SELECT forum_problem_signaled.idforum_problem,
    ...
    forum_problem_signaled.nom,
    forum_problem_signaled.prenom,
    forum_problem_signaled.email,
  ...
  WHERE ((forum_problem_signaled.etat = 0) AND (forum_problem_signaled.signal >= ( SELECT signal_advertissement.nbr
           FROM signal_advertissement)));
