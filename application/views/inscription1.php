            ...
            <form action="<?php bu('LogT/signuper2')?>" class="form formulaire" method="get">
                <div class="row">
                    <div class="col-md-6 equipe mt-4">
                        ...
                        <input type="text" class="form-control" name="nom" placeholder="Votre nom" value="<?php echo $nom?>">
                    </div>
                    <div class="col-md-6 equipe mt-4">
                        <i class="fas fa-user"></i>
                        <input type="text" class="form-control" name="prenom" placeholder="Votre prenom" value="<?php echo $prenom?>">
                    </div>
                </div>
                <div class="equipe mt-4">
                    <i class="fas fa-phone"></i>
                    <input type="text" class="form-control" name="contact" placeholder="Votre contact" value="<?php echo $contact?>">
                </div>
                <div class="equipe mt-4">
                    <i class="fas fa-envelope"></i>
                    <input type="email" class="form-control" name="email" placeholder="Votre email" value="<?php echo $email?>">
                </div>
                <div class="equipe mt-4">
                    <i class="fas fa-lock"></i>
                    <input type="password" class="form-control" name="mdp" placeholder="Votre mot de passe" value="<?php echo $mdp?>">
                </div>
                <div class="equipe mt-4">
                    <i class="fas fa-lock"></i>
                    <input type="password" class="form-control" name="mdp2" placeholder="Confirmer votre mot de passe" value="<?php echo $mdp?>">
                </div>
